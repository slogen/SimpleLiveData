...
namespace Scm.Linq.Tests
{
    public class FTests
    {
        ...
        void FExprRunsCorrectly()
        {
            ...
            F.Expr((int x, long y, double z) => x + y + z).Compile()(int.MaxValue, 1000, 2.25).Should().Be(int.MaxValue + 1000L + 2.25);
        }
        [Fact]
        void FFuncRunsCorrectly()
        {
            ...
            F.Func((int x, long y, double z) => x + y + z)(int.MaxValue, 1000, 2.25).Should().Be(int.MaxValue + 1000L + 2.25);
        }
    }
}
